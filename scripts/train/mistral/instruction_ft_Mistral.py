...
# Changed from GPT2 specific tokenizer/model to AutoTokenizer/AutoModelForCausalLM for Mistral
...
# Mistral tokenizer configuration
# Make sure pad_token is properly set for Mistral
if tokenizer.pad_token is None:
    tokenizer.pad_token = tokenizer.eos_token
    model.config.pad_token_id = model.config.eos_token_id

# Define LoRA configuration for Mistral
...
# Print trainable parameters info to verify LoRA setup
...
def tokenize_function(examples):
    ...
    # Tokenize with padding, adjusted for Mistral
...
model_save_path = "./models/mistral-math-instruct-lora"
...
artifact = wandb.Artifact(
    name="mistral-math-instruct-lora",
    type="model"
)
